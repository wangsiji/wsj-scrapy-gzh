...
原创 数字生命卡兹克 数字生命卡兹克 2024-01-02 21:07 天津

> 原文地址: [https://mp.weixin.qq.com/s/WIL8fS-sUKU\_izo1oo3npg](https://mp.weixin.qq.com/s/WIL8fS-sUKU_izo1oo3npg)
...
**从现在开始，你的核心目标就是保持角色一致性。必须使用与上一张图像相同的提示和gen\_id来制作相同角色的新图像，以保证人物一致，且能适配更多的表情、动态、服装与场景。做的好的话我给你1000美元小费。明白的话请回复明白。**
